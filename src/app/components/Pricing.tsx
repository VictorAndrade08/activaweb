        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-10 items-center">
              ...
              <div className="space-y-6 mb-12 flex-1 opacity-80">
                {['Sitio Web Completo (5 Páginas)', 'Hospedaje Cloud', 'Sistema de Citas / Reservas', 'Sección de Noticias / Blog'].map((text, idx) => (
                  <div key={idx} className="flex items-start gap-3 text-lg font-semibold text-[#0F172A]">
                    <CheckCircle2 size={24} className="text-[#64748B] shrink-0 mt-0.5" />
                    {text}
                  </div>
                ))}
              </div>

              {/* BOTÓN CAMBIADO: Enfoque en charla, no en cobro directo */}
              <a href="https://wa.me/593994715278?text=Hola%20Víctor,%20me%20gustaría%20hacerte%20unas%20preguntas%20sobre%20el%20plan%20Business%20Pro%20de%20$300" className="flex items-center justify-center gap-2 w-full text-center bg-white border-2 border-[#0F172A] text-[#0F172A] py-5 rounded-xl font-bold text-xl hover:bg-gray-50 transition-all active:scale-95">
            ...
            <div className="bg-white border-4 border-[#2563EB] rounded-[2rem] p-8 md:p-10 flex flex-col h-full shadow-[0_30px_60px_rgba(37,99,235,0.15)] relative transform md:-translate-y-4">
              ...
              <div className="mb-8 mt-3">
                ...
                <div className="flex items-center gap-2 text-base font-bold text-[#2563EB] bg-blue-50 px-4 py-2 rounded-xl w-max mb-4 mt-3">
                  <Zap size={20} className="fill-current" /> Se despliega HOY mismo
                </div>
              ...
              <div className="space-y-6 mb-12 flex-1">
                {['Landing Page Alta Conversión', 'Hospedaje Cloud', 'Dominio .com (1er año)', 'Dominación Google Maps', 'Botón WhatsApp Integrado', 'Entrega garantizada hoy'].map((text, idx) => (
                  <div key={idx} className="flex items-start gap-3 text-lg font-bold text-[#0F172A]">
                    <CheckCircle2 size={24} className="text-[#2563EB] shrink-0 mt-0.5" />
                    {text}
                  </div>
                ))}
              </div>

              {/* BOTÓN ESTRELLA: "Consultar" es más fácil de clickear que "Comprar" */}
              <a href="https://wa.me/593994715278?text=Hola%20Víctor,%20quisiera%20saber%20si%20mi%20clínica%20aplica%20para%20la%20web%20de%20$150%20con%20entrega%20hoy" className="flex items-center justify-center gap-2 w-full text-center bg-[#2563EB] text-white py-5 rounded-xl font-bold text-xl hover:bg-[#1d4ed8] transition-all shadow-xl shadow-blue-500/25 active:scale-95">
            ...
            <div className="bg-white border border-gray-200 rounded-[2rem] p-8 md:p-10 flex flex-col h-full shadow-sm hover:shadow-xl transition-shadow duration-300">
              ...
              <a href="https://wa.me/593994715278?text=Hola%20Víctor,%20necesito%20detalles%20del%20plan%20Elite%20para%20mi%20negocio" className="flex items-center justify-center gap-2 w-full text-center bg-white border-2 border-[#0F172A] text-[#0F172A] py-5 rounded-xl font-bold text-xl hover:bg-gray-50 transition-all active:scale-95">
                <MessageCircle size={20} />
                Pedir Detalles
              </a>
            </div>
          ...
          <div id="proceso" className="mt-24 relative pt-10 -mt-10">
            ...
            <div className="bg-[#0F172A] rounded-[2rem] p-8 md:p-14 flex flex-col md:flex-row items-center justify-between gap-10 shadow-2xl relative overflow-hidden group z-10 w-full max-w-4xl mx-auto border border-[#1e293b]">
              <div className="absolute -right-20 -top-20 w-80 h-80 bg-[#2563EB] opacity-20 blur-3xl rounded-full pointer-events-none" />
              ...
              >
                ...
                <ArrowRight size={24} className="text-[#2563EB] group-hover:translate-x-1 transition-transform" />
              </a>
            </div>
          </div>
